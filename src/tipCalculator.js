...
class TipCalculator extends Component {
  render() {
    return (
      <div>
        <div className="tipcalculator-box">
     
  <div className="userDropdown">
   
   <div className="font-08 mb-1 "> <a  className="userDropdown" href="#" >My projects</a></div>
   <div className="font-08 mb-1"> <a  className="userDropdown" href="#">Profile</a></div>
   <div className="font-08 mb-1 "> <a  className="userDropdown" href="#">Settings</a></div>
   <div className="font-08 "> <a className="userDropdown"  href="#">Logout</a></div>
